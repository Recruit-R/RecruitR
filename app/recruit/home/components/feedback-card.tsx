...
export function FeedbackCard({ feedbackFocus, setStudentView, currentStudent, setCurrentStudent, c }: FeedbackCardProps) {
    const csf = currentStudent && currentStudent.feedback ? (currentStudent.feedback["Karen"] ? currentStudent.feedback["Karen"] : null) : null
                    ...
                    <div className="flex flex-1 items-center space-x-4 pr-4">
                        ...
                        <div>
                            <CardTitle className="text-4xl">
                                {currentStudent && currentStudent.first_name} {currentStudent && currentStudent.last_name}
                            </CardTitle>
